...
* 获取
  ...
  ```sh
  wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/hors803/Xray-script/main/install.sh
  ```
...
* 快速启动(界面)
  ...
  ```sh
  wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/hors803/Xray-script/main/install.sh && bash ${HOME}/Xray-script.sh
  ```
...
Copyright (C) zxcvos | https://github.com/hors803/Xray-script
